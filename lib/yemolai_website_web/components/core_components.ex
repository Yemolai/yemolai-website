defmodule YemolaiWebsiteWeb.CoreComponents do
  @moduledoc """
  ...
  import YemolaiWebsiteWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YemolaiWebsiteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YemolaiWebsiteWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def desktop_topbar_link(assigns) do
    ~H"""
    <.link href={@href} class={["hover:text-zinc-700 underline capitalize", @class]}>
      <%= @label %>
    </.link>
    """
  end
